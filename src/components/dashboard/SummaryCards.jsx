  ...
  return (
    ...
    >
      {summaryData.map((item, index) => (
        ...
        >
          <Card className="overflow-hidden hover:shadow-xl transition-all relative group">
            {/* Gradient background */}
            <motion.div
              className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br ${item.gradient} opacity-10 rounded-full -mr-12 -mt-12`}
